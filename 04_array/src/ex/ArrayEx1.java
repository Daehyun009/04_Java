...
public class ArrayEx1 {
	 ...
	 * 
	 * - 생성된 배열의 요소(묶여진 배열)는 인덱스 번호로 구분된다! (index는 0부터 시작)
	 * 
	 * - 생성된 배열을 활용하기 위해서는 배열을 참조하는 "참조형 변수"를 이용한다
	 * 
	 * [참조형 변수] - 값이 아니라 주소를 저장하는 변수
	 * 
	 * - 변수 호출 시 반환 X 값을 반환하지 않음 -> 저장된 주소로 찾아가 해당 위치의 배열/객체를 참조
	 * 
	...
	/**
	 * 정수 4개를 입력 받아 배열 요소에 차례대로 대입 후 저장된 값 한 번에 출력하기
	 */
	public void method2() {
