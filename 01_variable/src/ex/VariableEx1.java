...
public class VariableEx1 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * -정수형- byte (1byte) short (2byte) int (4byte) - 정수 기본형(123 -> int로 인식) long
		...
		/*
		 * float (4byte), double (8byte) byte 크기가 2배라서 double이 아님!!!!
		 * 
		...
		/*
		 * string(문자열) - 기본 자료형(8가지)에 포함되지 않음!!!!
		 * 
		 * - 기본 자료형 O : 변수에 직접 값을 저장
		 * 
		 * - 기본 자료형 X : 변수에 값의 위치(주소)를 저장 == 참조형
		 */
