...
/**
 * 계좌 클래스 (class == 객체의 속성, 기능을 정의한 문서(설계도))
 * 
 */
...
public class Account {
	 ...
	 * 1) 객체의 속성, 기능을 하나로 묶음
	 * 
	 * 2) 외부로 부터의 직접 접근을 제한 - 내부가 보이지 않음 -> 정보 은닉 효과 발생
	 * 
	 * 
	 * [ 직접 접근을 제한하는 방법 ] - 접근을 제한할 속성에 private 키워드 추가 (private : 개인적인, 사적인) -> 현재
	 * 객체만 접근 가능한 (현재 객체 개인적인 것)
	 * 
	 * **************************************** 기본적으로 모든 클래스의 속성은 private을 적용 하는 것이
	 * 원칙!!! ****************************************
	 * 
	 */
